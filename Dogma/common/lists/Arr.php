...
class Arr
{
     ...
     * @return mixed[]
     */
    public static function diffKeys(array $array, array ...$args)
    {
     ...
     * @return mixed[]
     */
    public static function diffKeysWith(array $array, callable $function, array ...$args)
    {
        $args[] = $function;
     ...
     * @return mixed[]
     */
    public static function diffPairs(array $array, array ...$args)
    {
