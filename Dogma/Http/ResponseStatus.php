...
class ResponseStatus extends \Dogma\PartialEnum
{
    ...
    const S207_MULTI_STATUS = 207;
    const S208_ALREADY_REPORTED = 208;
    const S226_IM_USER = 226;
    ...
    const S420_ENHANCE_YOUR_CALM = 420;
    const S421_MISDIRECTED_REQUEST = 421;
    const S422_UNPROCESSABLE_ENTITY = 422;
    const S423_LOCKED = 423;
    const S424_FAILED_DEPENDENCY = 424;
    const S425_UNORDERED_COLLECTION = 425;
    ...
    const S506_VARIANT_ALSO_NEGOTIATES = 506;
    const S507_INSUFFICIENT_STORAGE = 507;
    const S508_LOOP_DETECTED = 508;
    const S509_BANDWIDTH_LIMIT_EXCEEDED = 509;
    const S510_NOT_EXTENDED = 510;
