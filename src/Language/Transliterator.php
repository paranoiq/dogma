...
class Transliterator extends \Transliterator
{
    ...
    public static function create($id, $direction = null): \Transliterator
    {
        ...
        $transliterator = parent::create($id, $direction);
        if ($transliterator === null) {
            throw new \Dogma\Language\TransliteratorException(intl_get_error_message());
        }
    ...
    {
        $transliterator = parent::createFromRules($rules, $direction);
        if ($transliterator === null) {
            throw new \Dogma\Language\TransliteratorException(intl_get_error_message());
        }
