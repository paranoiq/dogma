...
class UnicodeCharacterCategory extends \Dogma\Enum\StringEnum
{
    ...
    public const LOWERCASE_LETTER = 'Ll';
    ...
    private static $names = [
        ...
        self::LETTER => 'Letter',
        self::LOWERCASE_LETTER => 'Lowercase Letter',
        self::MODIFIER_LETTER => 'Modifier Letter',
        self::OTHER_LETTER => 'Other Letter',
        self::TITLE_CASE_LETTER => 'Titlecase Letter',
        self::UPPER_CASE_LETTER => 'Uppercase Letter',
        self::MARK => 'Mark',
