...
class DateTimeIntervalFormatter
{
     ...
     * p    Pretty, two values, letters                 "2w, 1d", "2w", "2w, -1d"
     * Q    Pretty, single value                        "15 days", "2 weeks", "13 days"
     * q    Pretty, single value, letters               "15d", "2w", "13d"
     *
     ...
     * @return string
     */
    public function format(DateTimeInterval $interval, ?string $format = null, ?int $maxDecimals = null, ?string $decimalPoint = null): string
    {
            ...
            if ($character === '%' && !$escaped) {
                ...
                switch ($character) {
                    ...
                    case self::YEARS_FRACTION:
                        $years = $interval->getYearsFraction();
                    ...
                    case self::YEARS_WORD:
                        $group .= $this->formatUnit(self::YEARS, $characters[$i + 1], $interval->getYears());
                        break;
                    ...
                    case self::MONTHS_FRACTION:
                        $months = $interval->getMonthsFraction();
                    ...
                    case self::MONTHS_TOTAL:
                        $months = (int) $interval->getMonthsTotal();
                        $group .= $months;
                        if ($months !== 0) {
                            $groupValid = true;
                        }
                    ...
                    case self::MONTHS_TOTAL_FRACTION:
                        $group .= $this->formatNumber($interval->getMonthsTotal(), $maxDecimals, $decimalPoint);
                        break;
                    case self::MONTHS_WORD:
                        $months = $last === self::MONTHS_TOTAL || $last === self::MONTHS_TOTAL_FRACTION
                            ? (int) $interval->getMonthsTotal()
                            : $interval->getMonths();
                    ...
                    case self::WEEKS_FRACTION:
                        $weeks = $interval->getWeeksFraction();
                    ...
                    case self::WEEKS_TOTAL:
                        $weeks = (int) $interval->getWeeksTotal();
                        $group .= $weeks;
                        if ($weeks !== 0) {
                            $groupValid = true;
                        }
                    ...
                    // days --------------------------------------------------------------------------------------------
                    case self::DAYS:
                        $days = $hasWeeks ? ($interval->getDays() - $interval->getWeeks() * 7) : $interval->getDays();
                        $group .= $days;
                        if ($days !== 0) {
                            $groupValid = true;
                        }
                    ...
                    case self::DAYS_FRACTION:
                        $days= $hasWeeks ? ($interval->getDaysFraction() - $interval->getWeeks() * 7) : $interval->getDaysFraction();
                    ...
                    case self::DAYS_TOTAL:
                        $days = (int) $interval->getDaysTotal();
                        $group .= $days;
                        if ($days !== 0) {
                            $groupValid = true;
                        }
                    ...
                    case self::DAYS_WORD:
                        $days = $last === self::DAYS_TOTAL || $last === self::DAYS_TOTAL_FRACTION
                            ? (int) ($hasWeeks ? ($interval->getDaysFraction() - $interval->getWeeks() * 7) : $interval->getDaysFraction())
                            : ($hasWeeks ? ($interval->getDays() - $interval->getWeeks() * 7) : $interval->getDays());
                    ...
                    case self::HOURS_FRACTION:
                        $hours = $interval->getHoursFraction();
                    ...
                    case self::HOURS_TOTAL:
                        $hours = (int) $interval->getHoursTotal();
                        $group .= $hours;
                        if ($hours !== 0) {
                            $groupValid = true;
                        }
                    ...
                    case self::MINUTES_FRACTION:
                        $minutes = $interval->getMinutesFraction();
                    ...
                    case self::MINUTES_TOTAL:
                        $minutes = (int) $interval->getMinutesTotal();
                        $group .= $minutes;
                        if ($minutes !== 0) {
                            $groupValid = true;
                        }
                    ...
                    case self::MINUTES_TOTAL_FRACTION:
                        $minutes = $interval->getMinutesTotal();
                        $group .= $this->formatNumber($minutes, $maxDecimals, $decimalPoint);
                        if ($minutes !== 0.0) {
                            $groupValid = true;
                        }
                    ...
                    case self::SECONDS_FRACTION:
                        $seconds = $interval->getSecondsFraction();
                    ...
                    case self::SECONDS_TOTAL:
                        $seconds = (int) $interval->getSecondsTotal();
                        $group .= $seconds;
                        if ($seconds !== 0) {
                            $groupValid = true;
                        }
                    ...
                    case self::SECONDS_TOTAL_FRACTION:
                        $seconds = $interval->getSecondsTotal();
                        $group .= $this->formatNumber($seconds, $maxDecimals, $decimalPoint);
                        if ($seconds !== 0.0) {
                            $groupValid = true;
                        }
                    ...
                    case self::MILISECONDS:
                        $microseconds = (int) ($interval->getMicroseconds() / 1000);
                        $group .= $microseconds;
                        if ($microseconds !== 0) {
                            $groupValid = true;
                        }
                    ...
                    case self::MILISECONDS_TOTAL:
                        $microseconds = (int) ($interval->getMicrosecondsTotal() / 1000);
                        $group .= $microseconds;
                        if ($microseconds !== 0) {
                            $groupValid = true;
                        }
                    ...
                    case self::MILISECONDS_WORD:
                        $group .= $this->formatUnit(self::MILISECONDS, $characters[$i + 1], (int) ($interval->getMicroseconds() / 1000));
                        break;
                    ...
                    case self::MICROSECONDS_TOTAL:
                        $microseconds = (int) $interval->getMicrosecondsTotal();
                        $group .= $microseconds;
                        if ($microseconds !== 0) {
                            $groupValid = true;
                        }
                    ...
                    case self::MICROSECONDS_WORD:
                        $group .= $this->formatUnit(self::MICROSECONDS, $characters[$i + 1], $interval->getMicroseconds());
                        break;
